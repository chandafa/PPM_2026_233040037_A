...
class ProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFF5F7FA), // 2. Tema Scaffold soft color
      appBar: AppBar(
        ...
        child: ListView(
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context); // 5. Tutup drawer
                showDialog(
                  context: context,
                  builder: (_) => AlertDialog(
                    title: const Text('Pengaturan'),
                    content: const Text(
                      'Menu pengaturan sedang dalam pengembangan.',
                    ),
                    actions: [
                      TextButton(
      ...
      body: SingleChildScrollView(
        // Kembalikan agar bisa di-scroll tanpa overflow
        padding: const EdgeInsets.all(16),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.stretch, // Kembalikan .stretch
          children: [
            // === HEADER PROFIL ===
            Center(
              child: Column(
                children: [
                  const CircleAvatar(
                    ...
                    // 1. Ganti CircleAvatar agar menampilkan foto (NetworkImage)
            ...
            const _SectionCard(
              icon: Icons.email,
              title: 'Kontak',
              content: 'ck271138@gmail.com\n+62 895404418536',
            ),
            // 3. Tambahkan Section Card ke-5 berjudul "Skills" dengan isi Wrap
            Card(
      ...
      // 6. Ganti BottomNavigationBar menjadi NavigationBar (Material 3)
      bottomNavigationBar: NavigationBar(
        selectedIndex: 1, // Highlight Profil
...
class GalleryHome extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final categories = [
      ...
      ('Input', Icons.edit, Colors.pink),
      ('Button', Icons.smart_button, Colors.amber.shade800),
      ('Feedback', Icons.notifications, Colors.deepPurple),
      ('Layout', Icons.dashboard, Colors.cyan.shade700),
    ];
    return Scaffold(
    ...
    return Column(
      ...
      children: [
        ...
        const Row(
          children: [
            Tooltip(
              message: 'Ini Tooltip (tekan lama/hover)',
              child: Icon(Icons.info, size: 40, color: Colors.blue),
            ),
            SizedBox(width: 24),
            Badge(label: Text('3'), child: Icon(Icons.shopping_cart, size: 40)),
          ],
        ),
      ],
    );
        ...
        SizedBox(
          ...
          child: Stack(
            children: [
              ...
              Positioned(
                bottom: 12,
                left: 12, // Diubah menjadi di kiri bawah
                child: Container(width: 50, height: 50, color: Colors.red),
              ),
              const Positioned(
                top: 12,
                right: 12, // Diubah menjadi di kanan atas
